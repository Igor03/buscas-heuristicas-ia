...
public class Romenia implements Problema {
	...
	public LinkedList<DLR> dlr = new LinkedList<>(); /* Nossa heuristica */
	...
	/* Construtor */
	public Romenia(String nomeEstadoInicial, String nomeObjetivo) {
		inicializarProblema();
	...
	public void inicializarProblema() {
		...
		// Distancia em linha reta de um ponto qualquer ate bucareste
		dlr.add(new DLR(Bucareste, Bucareste, 0));
		dlr.add(new DLR(Bucareste, Arad, 366));
		dlr.add(new DLR(Bucareste, Craiova, 160));
		dlr.add(new DLR(Bucareste, Dobreta, 242));
		dlr.add(new DLR(Bucareste, Eforie, 161));
		dlr.add(new DLR(Bucareste, Fagaras, 176));
		dlr.add(new DLR(Bucareste, Giurgiu, 77));
		dlr.add(new DLR(Bucareste, Hirsova, 151));
		dlr.add(new DLR(Bucareste, Iasi, 226));
		dlr.add(new DLR(Bucareste, Lugoj, 244));
		dlr.add(new DLR(Bucareste, Mehadia, 241));
		dlr.add(new DLR(Bucareste, Neamt, 234));
		dlr.add(new DLR(Bucareste, Oradea, 380));
		dlr.add(new DLR(Bucareste, Pitesti, 100));
		dlr.add(new DLR(Bucareste, Rimnieu_Vilcea, 193));
		dlr.add(new DLR(Bucareste, Sibiu, 253));
		dlr.add(new DLR(Bucareste, Timissoara, 329));
		dlr.add(new DLR(Bucareste, Urziceni, 80));
		dlr.add(new DLR(Bucareste, Vaslui, 199));
		dlr.add(new DLR(Bucareste, Zerind, 374));
	...
	public static void main(String[] args) {
		...
		Estado obj = romenia.Bucareste;
		LinkedList<Estado> teste = new LinkedList<>();

		System.out.println(romenia.getDLR(romenia.Bucareste, romenia.Sibiu));
		System.out.println(romenia.getDLR(romenia.Bucareste, romenia.Timissoara));
		System.out.println(romenia.getDLR(romenia.Bucareste, romenia.Zerind));
		...
		for (int i = 0; i < teste.size(); i++) {
			if (romenia.getDLR(obj, teste.get(i)) < maior) {
				maior = romenia.getDLR(obj, teste.get(i));
				esta = teste.get(i);
			}
		}
		System.out.println();
		System.out.println(maior);
		System.out.println(esta.nome);
